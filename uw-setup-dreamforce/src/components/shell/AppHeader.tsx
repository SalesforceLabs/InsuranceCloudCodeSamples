...
import { openSetupAssistant } from './setup-assistant-store';
import './AppHeader.css';

export function AppHeader() {
  return (
    <header className="slds2-app-header">
      <div className="slds2-app-header__left">
        <button className="slds2-app-header__launcher" aria-label="App Launcher" type="button">
        ...
        <span className="slds2-app-header__org">Salesforce</span>
        <span className="slds2-app-header__divider" />
        <span className="slds2-app-header__title">Setup</span>
      </div>
      <div className="slds2-app-header__right">
        <div className="slds2-app-header__search">
          <Icon name="search" size={14} />
          <input type="text" placeholder="Search Setup" />
        </div>
        <button
          type="button"
          className="slds2-app-header__assistant"
        ...
        <button className="slds2-app-header__avatar" type="button" aria-label="User menu">NS</button>
      </div>
    </header>
  );
}
